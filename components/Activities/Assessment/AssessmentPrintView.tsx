...
export const AssessmentPrintView: React.FC<AssessmentPrintViewProps> = ({
    ...
    useEffect(() => {
        ...
        document.title = `Generated by ClassFlow for ${className || 'Student'}`;
        ...
        <div id="assessment-print-view">
            <style>{`
                @media print {
                    @page {
                        @bottom-right {
                            content: "Generated by ClassFlow for ${className || 'testing class'} | Page " counter(page) " of " counter(pages);
                            font-size: 9pt;
                            color: #666;
                        }
                    }
