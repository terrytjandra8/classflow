    ...
    return (
        <div className={`h-full flex flex-col bg-[#111] text-white overflow-hidden ${isPresenting ? 'fixed inset-0 z-[100]' : ''}`}>
            ...
            {!isPresenting && !isPresentationMode && (
                <div className="h-14 bg-[#1a1a1a] border-b border-white/10 flex items-center justify-between px-4 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={openProjectorMode} className="bg-green-600 hover:bg-green-700 text-white px-4 py-1.5 rounded-lg font-bold text-xs flex items-center gap-2 transition-transform active:scale-95">
            ...
            <div className="flex-1 flex overflow-hidden">
                {isSidebarOpen && !isPresenting && !isPresentationMode && (
